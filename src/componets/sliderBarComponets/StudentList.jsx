...
import PopupAdd from "./StudentListPopup/StudentListPopupAdd";
import PopupView from "./StudentListPopup/StudentListPopup";
import Navbar from "../Navbar";
import SideBar from "../SideBar";
import dbConfig from "../../config.json";
import PopupBlock from "./StudentListPopup/StudentBlock";
import Delete from "./StudentListPopup/StudentDelete";
...
const StudentList = () => {
  ...
  // console.log(buildingData, "555555555555555");
  ...
  // console.log(selectedFilter, "22222222");
  ...
  const fetchData = async () => {
    try {
      ...
      if (response.ok) {
        ...
        // console.log(fetchedData,"4444444444444");
  ...
  const fetchBuildingData = async () => {
    try {
      ...
      if (response.ok) {
        const fetchedData = await response.json();
        // console.log(fetchedData,"2222222222");
  ...
  return (
    <>
      <div className="popup">
        ...
        {block && (
          <div className="popupbackground">
            <PopupBlock Student={viewOneData} onClose={closeBlockPopup} fetchData={fetchData}></PopupBlock>
          </div>
        )}
      ...
      <div className="mainDivNAV">
        ...
        <div className="second-Div">
          ...
          <div className="h-scree three">
            ...
            <div className="NAMEandBUTTON1">
              <div className="NAMEandBUTTONLeft1">
              ...
              <div className="d-flex flex-row grid gap-4 NAMEandBUTTONLeft2">
                ...
                <div className="NAMEandBUTTONRight1" onClick={openPopup}>
                  <div>
            ...
            <div className="compailntbuttonbuilding ">
              <div className="ComplainPopupBTNDIVFilter">
                ...
                >
                  ...
                  <option value="Pending,Manager">Pending Payments</option>
                  <option value="Online,Admin">Received Payments</option>
                  <option value="Admin,Admin">Cash Payments</option>
                </select>
              </div>
              ...
              <div className="flex flex-wrap flex-column ManagerManagement">
                <div className="Allcontant">
                    ...
                    .map((filteredItem, index) => (
                      ...
                      >
                        ...
                        <div className="contant_Text">
                          ...
                          {filteredItem.BuildingDetails && filteredItem.BuildingDetails.map((e, index) => (
                            <div key={index}>
                              {e.Building}
                            </div>
                          ))}
                  ...
                  {studentData && studentData.length > 0 ? (
                      ...
                      {studentData
                        ...
                        .filter((item) => {
                          if (selectedFilter === "" || selectedFilter === null) {
                            ...
                            const filterValues = selectedFilter.split(',');
                            return (
                              (item.paymentStatus === filterValues[0]) || (item.CashTaken === filterValues[1])
                              ||
                              (item.CashTaken === filterValues[0]) || (item.CashTaken === filterValues[1])
                              ||
                              (item.CashTaken === filterValues[0]) || (item.CashTaken === filterValues[1])
                            );
                          }
                          ...
                          >
                            <div className="contant_Image ">
                              ...
                              {filteredItem.addDocuments && filteredItem.addDocuments.length > 0 ? (
                                ...
                                <div >
                                  <img
                                    // E:\Aftab\PG\ZZZZZZZZZZZ\All\Live\public\defaultImage.png
                            ...
                            <div className="contant_Text">
                              ...
                              {/* <h6>Building Assigned: N/A</h6> */}
                              {/* {filteredItem.BuildingDetails.Building} */}
                              <div className="contant_TextRECEIVED grid gap-1">
                                <h6>Payment Status :</h6>
                                <p
                                  className=""
                              ...
                              {editButtonVisibility[filteredItem._id] && (
                                <div className="buttonContainer mt-3 d-flex justify-content-center">
                                  <button onClick={() => handleOneView(filteredItem._id)}>
                                    <h6>View</h6>
                                  </button>
                                  <button >
                                    <h6 onClick={() => handleBlock(filteredItem._id)} >Block</h6>
                                  </button>
                                  <button >
                                    <h6 onClick={() => handleDelete(filteredItem._id)}>Delete</h6>
                                  </button>
                                </div>
                              )}
                            </div>
                    ...
                    // <p style={{margin:"35px", fontSize:"12px", color:"red" }}>No data available</p>
                  )}
