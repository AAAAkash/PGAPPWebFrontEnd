...
const Delete = ({ onClose, fetchData, isRoom , Data}) => {
  // console.log(isRoom._id,"222222222222")
  ...
  const handleDelete = async (e) => {
    ...
    try {
        const response = await fetch(
            dbConfig.backendBaseUrl + `main/RoomsData/RoomRemove/${isRoom._id}`,
            {
                method: "DELETE",
                headers: {
                    "x-access-token":
  ...
  return (
    <div className="DELETEROOM">
      ...
      <div className='DELETEROOMHeading'>
        <h6>Do you want to Delete the room ?</h6>
      </div>
